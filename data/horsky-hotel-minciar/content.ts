      ...
      items: [
        {
          ...
          description:
            'Ako poďakovanie za objednaný animačný program získa vaša škola odmenu 100 € za každých 10 platiacich detí. K tomu si môžete za príplatok 35 € na dieťa pripočítať autobusovú dopravu do Kremnice s vstupom do Štôlne Andrej, a darček na pamiatku pre každého účastníka.',
