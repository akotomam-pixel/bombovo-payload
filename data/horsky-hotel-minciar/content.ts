...
export const horskyHotelMinciarContent: LomyContent = {
  ...
  hero: {
    ...
    facts: [
      ...
      { label: 'Dostupné termíny', value: 'máj', icon: '📅' },
    ],
  ...
  terminy: {
    ...
    upozornenie: true,
    items: [
      { range: '10.05. – 14.05.2027', price: '220 €', discounted: '190 €', status: 'Rezervované' },
      ...
      { range: '31.05. – 04.06.2027', price: '220 €', discounted: '190 €', status: 'Rezervované' },
