...
export const hotelOsrblieContent: LomyContent = {
  ...
  terminy: {
    ...
    items: [
      ...
      { range: '07.06. – 11.06.2027', price: '235 €', discounted: '205 €', status: 'Voľné', volnychMiest: 60 },
      { range: '14.06. – 18.06.2027', price: '235 €', discounted: '205 €', status: 'Rezervované' },
      { range: '21.06. – 25.06.2027', price: '235 €', discounted: '205 €', status: 'Voľné', volnychMiest: 65 },
    ],
  },
}
