...
export const hotelMartinskeHoleContent: LomyContent = {
      ...
      items: [
        {
          ...
          description:
            'Ako poďakovanie za objednaný animačný program získa vaša škola odmenu 100 € za každých 10 platiacich detí. K tomu si môžete za príplatok 35 € na dieťa pripočítať lukostreľbu priamo na stredisku, a darček na pamiatku pre každého účastníka.',
  ...
  terminy: {
    ...
    items: [
      ...
      { range: '24.05. – 28.05.2027', price: '225 €', discounted: '195 €', status: 'Voľné' },
