...
/**
 * The short enquiry page for a rebuilt stredisko, rendered at
 * /prihlaska-svp/{slug} in place of the long registration form.
 *
 ...
 * popup render. Shared across every rebuilt stredisko, not just Lomy — the
 * slug and name come in as props rather than being hardcoded.
 */
export default function LomyEnquiryPage({
  slug,
  strediskoName,
  initialTerm,
}: {
