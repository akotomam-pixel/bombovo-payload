    ...
    try {
      if (profisTerminId) {
        ...
        const extras = [
          ...
          formData.tshirtSize ? `Tričko: ${tshirtSizes.find(s => String(s.id) === formData.tshirtSize)?.nazev ?? formData.tshirtSize}` : '',
          formData.hasSecondChild && formData.tshirtSize2 ? `Tričko 2: ${tshirtSizes.find(s => String(s.id) === formData.tshirtSize2)?.nazev ?? formData.tshirtSize2}` : '',
